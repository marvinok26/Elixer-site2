    ...
    <section className="testimonials section-padding bg-gray5 style-5" data-scroll-index="5">
      <div className="container">
        <div className="section-head text-center mb-60 style-5">
          ...
          <p>{ rtl ? 'لقد أحببت Elixerr من آلاف العملاء في جميع أنحاء العالم وحصلت على ثقة من الشركات الكبرى.' : 'Elixerr loved from thoudsands customer worldwide and get trusted from big companies.' }</p>
        </div>
      </div>
