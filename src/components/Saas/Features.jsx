          ...
          <div className="col-lg-8">
            {
              ...
              (
                <div className="section-head text-center mb-60 style-5">
                  ...
                  <p>
                    Elixerr Dashboard is a powerhouse when it comes to the feature list. This ensures you have every functionality you need to build, run, and expand your marketplace
                  </p>
                </div>
              )
            }
