      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-lg-4">
            ...
            <p>
              { rtl ? 'مع سوق Elixerr ، اختر من بين مئات بوابات الدفع لعملائك. من PayPal إلى Stripe إلى Skrill ، Visa Debit ، Master Card ، إلخ' : 'With Elixerr Marketplace, choose from hundreds of payment gateways for your customers. From PayPal to Stripe to Skrill, Visa Debit, Master Card, etc' }
            </p>
