      ...
      <div className="container">
        <div className="row gx-0 justify-content-between">
          <div className="col-lg-3 col-sm-6">
            <div className="items">
              <div className="title">
                Elixerr - 1st eCommerce Dashboard
              </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <small className="small">
                © 2022 Copyrights by <a href="#" className="fw-bold text-decoration-underline">Elixerr Co.</a> All Rights Reserved. Designed by <a href="https://themeforest.net/user/themescamp" className="fw-bold text-decoration-underline">ThemesCamp</a>
              </small>
            </div>
          </div>
        </div>
